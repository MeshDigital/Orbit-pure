...
public interface IAudioAnalysisService
{
    ...
    Task<AudioAnalysisEntity?> AnalyzeFileAsync(string filePath, string trackUniqueHash, IProgress<(int Percent, string Step)>? progress = null, string? correlationId = null, System.Threading.CancellationToken cancellationToken = default);
